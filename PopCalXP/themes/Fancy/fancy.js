...
var gsCalTitle="\"<a class='PopAnchor' href='javascript:void(0);' onclick='if(this.blur)this.blur();fPopMenu(this,2,event);return false;' >&nbsp;\"+gMonths[gCurMonth[1]-1]+\"<IMG  SRC='down.gif' width=12 height=10 border=0></a> <a class='PopAnchor' href='javascript:void(0);' onclick='if(this.blur)this.blur();fPopMenu(this,1,event);return false;' >&nbsp;\"+gCurMonth[0]+\"<IMG SRC='down.gif' width=12 height=10 border=0></a>\"";	// dynamic statement to be eval()'ed as the title when giDCStyle>0.
...
var gsNavPrev="<A id='navPrev' class='PopAnchor' href='javascript:void(0)' onmousedown='showPrevMon();return false;' onmouseup='stopShowMon();if(this.blur)this.blur()' onmouseout='stopShowMon();if(this.blur)this.blur()' onmouseover='return true;' >&nbsp;<IMG src='left.gif' width=10 height=11 border=0>&nbsp;</A> <A id='navNext' class='PopAnchor' href='javascript:void(0)' onmousedown='showNextMon();return false;' onmouseup='stopShowMon();if(this.blur)this.blur()' onmouseout='stopShowMon();if(this.blur)this.blur()' onmouseover='return true;' >&nbsp;<IMG src='right.gif' width=10 height=11 border=0>&nbsp;</A>";	// the content of the left month navigator
var gsNavNext="<A class='PopAnchor' href='javascript:void(0)' onclick='fHideCal();return false;' onmouseover='return true;' >&nbsp;<IMG src='close.gif' width=10 height=11 border=0>&nbsp;</A>";	// the content of the right month navigator

var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
var gsBottom="<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' title='Go to today!'>Today is "+gd.toString().substring(0,3)+", "+gToday[2]+" "+gMonths[gToday[1]-1].substr(0,3)+" "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcFGToday="#0000aa";	// the font color for today 
var gcBGToday="red";	// the background color for today 
...
var guSelectedBGImg="selected.gif";	// url of image as background of the selected date
var giMarkSelected=8+16;	// Effects for selected date - 0: nothing; 1: set background color with gcBGSelected; 2: draw a box with gcBGSelected; 4: bold the font; 8: set font color with gcFGSelected; 16: set background image with guSelectedBGImg; - they can be added up to create mixed effects.
...
var gAgendaMask=[-1,-1,gcCellBG,-1,null,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.js. Check the tutorial for details.
