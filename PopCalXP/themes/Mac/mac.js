...
var guCalBG="bkgnd_cal.gif";	//  the background image url for the inner table.
var gcCalFrame="";	// the background color of the inner table, showing as a frame.
...
var gsOuterTable=NN4?"border=1 cellpadding=0 cellspacing=2":"border=0 cellpadding=0 cellspacing=4";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var giCellHeight=NN4?16:15;	// calendar cell height;
...
var giWeekTop=2;	// calendar week-number-column top offset;
...
var gcWorkday="#111111";	// Workday font color
var gcSat="#111111";	// Saturday font color
var gcSatBG=null;	// Saturday background color
var gcSun="#111111";	// Sunday font color
var gcSunBG=null;	// Sunday background color

var gcOtherDay="#c0c0c0";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
var gcOtherDayBG="";	// the background color of days in other months. when giShowOther set to hiding, it'll substitute the gcOtherDay.
var giShowOther=0;	// control the look of days in OTHER months. 1: show date & agendas effects; 2: show selected & today effects; 4: hide days in previous month; 8: hide days in next month; 16: when set with 4 and/or 8, the days will be visible but not selectable.  NOTE: values can be added up to create mixed effects.
...
var gcFGToday="#2E73F2";	// the font color for today 
var gcBGToday="#5EA3ED";	// the background color for today
...
var gcBGSelected="#999900";	// the background color for the selected date
...
var gAgendaMask=[-1,-1,null,-1,null,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.js. Check the tutorial for details.
