...
function fOnDrag(y,m,d,aStat,e) {
	if (aStat==0) {
		...
		fRunInOtherCtx("__lastDrag=null");
	} else if (aStat==1)
		if (!fIsSelected(y,m,d)) {
...
////////////////////////////////////////////////////////////////////
function fOnload() {
	if (gTheme[3]=="gfFlat_1"&&gContainer.fInitAgenda) gContainer.fInitAgenda();
}
...
function fRemoveDate(y,m,d) {
	if (gContainer.fRemoveListItem) gContainer.fRemoveListItem(fDateString(y,m,d),gfSelf);
}
