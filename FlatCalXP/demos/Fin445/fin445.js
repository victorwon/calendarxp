...
var giFirstDOW=new Date(gToday[0], 0, 1).getDay();	// indicates the first day of week. 0:Sunday; 1-6:Monday-Saturday.
var gb445=true; // enable/disable 445 accounting mode
var giFirstMonth=1; // the 1st month of a year. 1-12: Jan-Dec
...
var gcCalFrame="#000000";	// the background color of the inner table, showing as a frame.
...
var gsCalTitle="'<div style=\"width:100%\" title=\"'+gMonths[gCurMonth[1]-1]+'\"><a class=MonthNav href=\"javascript:void(0)\"  onclick=\"fHeaderClick('+gCurMonth[0]+','+gCurMonth[1]+');return false\">Period '+((gCurMonth[1]-giFirstMonth+12)%12+1)+'</a></div>'";	// dynamic statement to be eval-ed as the title when giDCStyle>0.
...
var giCellWidth=12;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
...
var gsWeekHead="wk";	// the text shown in the table head of week-number-column.
...
var gcOtherDay="black";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
...
var gcToggle="#99FF99";	// the highlight color for the focused cell
...
var giMarkToday=0; // Effects for today - 0: nothing; 1: set background color with gcBGToday; 2: draw a box with gcBGToday; 4: bold the font; 8: set font color with gcFGToday; 16: set background image with guTodayBGImg; - they can be added up to create mixed effects.
var gsTodayTip="Today";	// tooltip for today

var gcFGSelected="black";	// the font color for the selected date
var gcBGSelected="#99FF99";	// the background color for the selected date
