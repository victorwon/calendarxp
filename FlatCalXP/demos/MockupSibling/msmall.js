...
var gbHideTop=true;	// true: hide the top section; false: show it according to the following settings
...
var giCellWidth=20;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=20;	// calendar cell height;
var giHeadHeight=18;	// calendar head row height;
var giWeekWidth=18;	// calendar week-number-column width;
var giHeadTop=2;	// calendar head row top offset;
var giWeekTop=0;	// calendar week-number-column top offset;

var gcCellBG="#F8E8C8";	// default background color of the cells. Use "" for transparent!!!
...
var gcOtherDayBG="white";	// the background color of days in other months. when giShowOther set to hiding, it'll substitute the gcOtherDay.
...
var gcBGToday="#C47F10";	// the background color for today 
...
var gcFGSelected="#990000";	// the font color for the selected date
...
var gAgendaMask=[-1,-1,-1,-1,null,null,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.js. Check the tutorial for details.
