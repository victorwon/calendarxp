...
var gcCalBG="#e5e5e5";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="black";	// the background color of the inner table, showing as a frame.
...
var gsOuterTable=NN4?"border=1 cellpadding=3 cellspacing=0":"border=0 cellpadding=0 cellspacing=0";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var giCellWidth=75;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=30;	// calendar cell height;
var giHeadHeight=20;	// calendar head row height;
var giWeekWidth=22;	// calendar week-number-column width;
var giHeadTop=2;	// calendar head row top offset;
...
var gsDays="myDayStr(week,day,sCellDate)";	// the dynamic statement to be eval()'ed into each day cell.
...
var gcToggle="#ff7f50";	// the highlight color for the focused cell

var gcFGToday="";	// the font color for today 
var gcBGToday="";	// the background color for today 
var guTodayBGImg="today.gif";	// url of image as today's background
var giMarkToday=16; // Effects for today - 0: nothing; 1: set background color with gcBGToday; 2: draw a box with gcBGToday; 4: bold the font; 8: set font color with gcFGToday; 16: set background image with guTodayBGImg; - they can be added up to create mixed effects.
var gsTodayTip="Today";	// tooltip for today

var gcFGSelected="black";	// the font color for the selected date
var gcBGSelected="#ddddea";	// the background color for the selected date
var guSelectedBGImg="";	// url of image as background of the selected date
var giMarkSelected=1+2+4;	// Effects for selected date - 0: nothing; 1: set background color with gcBGSelected; 2: draw a box with gcBGSelected; 4: bold the font; 8: set font color with gcFGSelected; 16: set background image with guSelectedBGImg; - they can be added up to create mixed effects.
