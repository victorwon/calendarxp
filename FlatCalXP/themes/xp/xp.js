...
var gcCalBG="#0165F9";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#4BBF4B";	// the background color of the inner table, showing as a frame.
...
var gsOuterTable=NN4?"border=0 cellpadding=0 cellspacing=3":"border=0 cellpadding=0 cellspacing=2";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='navl.gif' width='15' height='15' border='0' alt='' align='absmiddle' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='navr.gif' width='15' height='15' border='0' alt='' align='absmiddle' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var giCellWidth=24;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=20;	// calendar cell height;
var giHeadHeight=18;	// calendar head row height;
var giWeekWidth=20;	// calendar week-number-column width;
var giHeadTop=0;	// calendar head row top offset;
var giWeekTop=0;	// calendar week-number-column top offset;

var gcCellBG="#EDEAD8";	// default background color of the cells. Use "" for transparent!!!
...
var gcOtherDay="#DDDDDD";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
var gcOtherDayBG="#999999";	// the background color of days in other months. when giShowOther set to hiding, it'll substitute the gcOtherDay.
var giShowOther=4+8+16;	// control the look of days in OTHER months. 1: show date & agendas effects; 2: show selected & today effects; 4: hide days in previous month; 8: hide days in next month; 16: when set with 4 and/or 8, the days will be visible but not selectable.  NOTE: values can be added up to create mixed effects.

var gbFocus=false;	// whether to enable the gcToggle highlight whenever mouse pointer focuses over a calendar cell.
var gcToggle="#FFCF0F";	// the highlight color for the focused cell

var gcFGToday="white";	// the font color for today 
var gcBGToday="#DB5141";	// the background color for today 
var guTodayBGImg="";	// url of image as today's background
var giMarkToday=1+8; // Effects for today - 0: nothing; 1: set background color with gcBGToday; 2: draw a box with gcBGToday; 4: bold the font; 8: set font color with gcFGToday; 16: set background image with guTodayBGImg; - they can be added up to create mixed effects.
...
var gAgendaMask=[-1,-1,-1,"black",null,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.js. Check the tutorial for details.
