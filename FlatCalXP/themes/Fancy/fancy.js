...
var gsNavPrev="<A id='navPrev' class='PopAnchor' href='javascript:void(0)' onmousedown='showPrevMon();return false;' onmouseup='stopShowMon();if(this.blur)this.blur()' onmouseout='stopShowMon();if(this.blur)this.blur()' onmouseover='return true;' HIDEFOCUS>&nbsp;<IMG src='left.gif' width=10 height=11 border=0>&nbsp;</A>";	// the content of the left month navigator
var gsNavNext="<A id='navNext' class='PopAnchor' href='javascript:void(0)' onmousedown='showNextMon();return false;' onmouseup='stopShowMon();if(this.blur)this.blur()' onmouseout='stopShowMon();if(this.blur)this.blur()' onmouseover='return true;' HIDEFOCUS>&nbsp;<IMG src='right.gif' width=10 height=11 border=0>&nbsp;</A>";	// the content of the right month navigator
...
var giCellWidth=22;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
